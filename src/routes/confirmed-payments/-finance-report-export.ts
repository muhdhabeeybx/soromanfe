...
function summaryColumns(
  ...
  const cols: Array<{ header: string; value: string | number; fmt?: string; signed?: boolean }> = [
     ...
     *
     * "Of Which Transferred" and "Total Differential" were both here. Each was
     * a number to reconcile against another number in the same block rather
     * than an answer, and both now have columns of their own in the table
     * below, footed in its totals row.
     */
